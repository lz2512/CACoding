...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUseCase(clearViewModel, clearDAO);
    ...
    private static ClearController createClearUseCase(ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessInterface){
